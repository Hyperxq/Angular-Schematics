 ...
 */ function addShortImportToTsConfig(tsconfigContent, pathAlias, pathValue, behavior = 'update') {
    let tsconfig;
    ...
    if (existingPath) {
        switch(behavior){
            ...
            case 'merge':
                ...
                tsconfig.compilerOptions.paths[pathAlias] = Array.from(new Set([
                    ...existingPath,
                    pathValue
                ]));
                break;
...
exports.addShortImportToTsConfig = addShortImportToTsConfig;
